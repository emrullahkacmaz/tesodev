...
import { Search, StyledInputBase } from "../Components/Search/searchStyles";
            ...
            >
              <button
                ...
                style={{
                  ...
                  borderRadius: "8px",
                  backgroundColor:
                    selectOrder === 1 ? "#B3B3B3" : "transparent",
                  fontSize: "14px",
                  fontWeight: 700,
                  lineHeight: "16px",
                  fontFamily: "Roboto",
              ...
              <button
                ...
                style={{
                  ...
                  borderRadius: "8px",
                  backgroundColor:
                    selectOrder === 2 ? "#B3B3B3" : "transparent",
                  fontSize: "14px",
                  fontWeight: 700,
                  lineHeight: "16px",
                  fontFamily: "Roboto",
              ...
              <button
                ...
                style={{
                  ...
                  borderRadius: "8px",
                  backgroundColor:
                    selectOrder === 3 ? "#B3B3B3" : "transparent",
                  fontSize: "14px",
                  fontWeight: 700,
                  lineHeight: "16px",
                  fontFamily: "Roboto",
              ...
              <button
                ...
                style={{
                  ...
                  borderRadius: "8px",
                  backgroundColor:
                    selectOrder === 4 ? "#B3B3B3" : "transparent",
                  fontSize: "14px",
                  fontWeight: 700,
                  lineHeight: "16px",
                  fontFamily: "Roboto",

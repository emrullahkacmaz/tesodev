...
const FormAdd = () => {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", backgroundColor:'#E5E5E5'}}>
        ...
        <div style={{ flex: 1 }}>
          ...
          <img
            src={logo}
            alt="Canvas Logo"
            style={{ width:'149px', height:'63px', marginLeft:'37px', marginTop:'27px' }}
          />{" "}
          <button
            onClick={goToMain}
            style={{
        ...
        <div>
            ...
            src={backArrow}
            alt="Canvas Logo"
            style={{ width:'26px', marginLeft:'37px', marginTop:'27px' }}
          /> 
          </div>
          <div style={{marginTop:'24px', marginLeft:'12px', fontFamily:'Roboto', fontWeight:700, fontSize:'24px',lineHeight:'28px'}}> Return to List Page </div> 
          </div>
          </button>
        </div>
      </div>
      ...
      {errPop && (
        ...
        >
          <div style={{ height: 15 }}>
            ...
            src={closeIcon}
            alt="Canvas Logo"
            style={{ width:'20px', height:'20px', marginLeft:'331px', marginTop:'11px' }}
          />{" "}
            </button>
          </div>
          <div
          ...
          <div
            style={{ fontFamily:'Inter', fontWeight:400,fontSize:'13px',lineHeight:'24px',color:'#090A0A', marginLeft:'18px', width:'204px',height:'48px' }}
          >
            {" "}

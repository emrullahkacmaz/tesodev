    ...
    <div style={{ display: "flex", flexDirection: "column" }}>
      <div style={{ flexDirection: "row", flex: 1 }}>
        <div style={{ flex: 1 }}>
          ...
          >
            {" "}
            <KeyboardBackspaceSharpIcon /> Return to List Page{" "}
          </button>
        </div>
      </div>
            ...
            >
              <div style={{ height: 80, width: 600 }}>
                <div
                  style={{
                    fontWeight: "bold",
                    color: errors.nameSurname ? "red" : "black",
                  }}
                >
                  Name Surname
                </div>
                <Field
                  style={{
                    ...
                    borderRadius: 18,
                    marginTop: 5,
                    borderColor: errors.nameSurname ? "red" : "black",
                  }}
                  name="nameSurname"
                  placeholder="Enter name and surname"
                />
                {touched.nameSurname && errors.nameSurname && (
                  <div style={{ color: "red" }}>{errors.nameSurname}</div>
                )}
              </div>
              ...
              <div style={{ height: 80, width: 600, marginTop: 10 }}>
                <div
                  style={{
                    fontWeight: "bold",
                    color: errors.country ? "red" : "black",
                  }}
                >
                  Country
                </div>
                <Field
                  style={{
                    ...
                    borderRadius: 18,
                    marginTop: 5,
                    borderColor: errors.country ? "red" : "black",
                  }}
                  name="country"
              ...
              <div style={{ height: 80, width: 600, marginTop: 10 }}>
                ...
                <Field
                  style={{
                    ...
                    borderRadius: 18,
                    marginTop: 5,
                    borderColor: errors.city ? "red" : "black",
                  }}
                  name="city"
      ...
      {errPop && (
        ...
        >
          ...
          >
            <div style={{ color: "white", marginLeft: 10 }}> Error </div>{" "}
          </div>
          <div
            style={{ height: 48, fontSize: "14px", width: 240, marginLeft: 18 }}
          >
            {" "}
